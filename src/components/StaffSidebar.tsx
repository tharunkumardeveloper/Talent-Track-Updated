...
const navigationItems = [
  ...
  { title: "Leaderboard", url: "/staff/leaderboard", icon: TrendingUp },
  { title: "Events", url: "/staff/events", icon: Calendar },
...
export function StaffSidebar() {
  ...
  const handleNavClick = () => {
    console.log("Staff nav clicked, isMobile:", isMobile, "current state:", state);
    if (isMobile) {
      setOpenMobile(false);
    } else {
            ...
            <div className="flex items-center gap-3">
              ...
              {!isCollapsed && (
                <div>
                  ...
                  <p className="text-sm text-accent">Staff Portal</p>
                </div>
              )}
            </div>
