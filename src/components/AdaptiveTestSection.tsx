...
const adaptiveExercises = [
  {
    ...
    emoji: "💺",
    icon: Hand,
    description: "Upper body strength exercise designed for wheelchair users and seated athletes",
    duration: "2 minutes",
    difficulty: "Beginner",
    color: "text-gamification-bronze",
    instructions: "Sit upright in your chair or wheelchair. Place hands on armrests or chair sides. Push your body up using arm strength, lifting your weight off the seat. Lower back down slowly and repeat.",
    modifications: ["Use chair with armrests", "Adjust hand position for comfort", "Start with partial lifts"],
    benefits: ["Upper body strength", "Core stability", "Functional mobility"],
    subtitles: "Place hands firmly on armrests • Push up with control • Lower slowly • Breathe steadily"
  },
  {
    id: "arm-strength-bands",
    name: "Resistance Band Arm Test",
    emoji: "🎯",
    icon: Hand,
    description: "Measure upper body strength using resistance bands or assisted devices",
    duration: "3 minutes",
  ...
  {
    id: "breathing-endurance",
    name: "Breathing Endurance Test",
    emoji: "🫁",
    icon: Heart,
    description: "Assess respiratory capacity and control through guided breathing exercises",
    duration: "4 minutes",
    difficulty: "Beginner",
    color: "text-primary",
    instructions: "Sit comfortably with back straight. Breathe in deeply through nose for 4 counts, hold for 4 counts, exhale through mouth for 6 counts. Maintain steady rhythm throughout the test.",
    modifications: ["Adjust breathing pattern as needed", "Use shorter counts if difficult", "Take breaks if necessary"],
    benefits: ["Lung capacity", "Relaxation response", "Core stability"],
    subtitles: "Inhale for 4 counts • Hold breath briefly • Exhale slowly for 6 counts • Keep rhythm steady"
  },
  {
    id: "wheelchair-shuttle",
    name: "Modified Shuttle Exercise",
    emoji: "♿",
    icon: Car,
    description: "Agility and speed test adapted for wheelchair users or those with mobility aids",
    duration: "5 minutes",
    difficulty: "Intermediate",
    color: "text-gamification-gold",
    instructions: "Navigate between two points 10 feet apart. Move as quickly as safely possible between markers. Focus on smooth turns and consistent speed. Use your preferred mobility method.",
    modifications: ["Adjust distance as needed", "Use wider turning radius", "Allow walking aids or support"],
    benefits: ["Agility", "Coordination", "Cardiovascular fitness"],
