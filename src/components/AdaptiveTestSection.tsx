...
const adaptiveExercises = [
  {
    ...
    modifications: ["Use padded surface for knees", "Adjust hand position for comfort", "Start with partial range"],
    benefits: ["Upper body strength", "Core stability", "Modified mobility"],
    subtitles: "Position knees comfortably • Lower chest with control • Push up smoothly • Maintain straight line"
  },
  {
