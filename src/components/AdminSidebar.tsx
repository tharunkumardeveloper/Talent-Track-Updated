...
const navigationItems = [
  ...
  { title: "Top Players", url: "/admin/top-players", icon: Star },
  { title: "Organize Events", url: "/admin/organize-events", icon: Calendar },
...
export function AdminSidebar() {
  ...
  const handleNavClick = () => {
    console.log("Admin nav clicked, isMobile:", isMobile, "current state:", state);
    if (isMobile) {
      setOpenMobile(false);
    } else {
            ...
            <div className="flex items-center gap-3">
              ...
              {!isCollapsed && (
                <div>
                  ...
                  <p className="text-sm text-success">Admin Portal (SAI)</p>
                </div>
              )}
            </div>
