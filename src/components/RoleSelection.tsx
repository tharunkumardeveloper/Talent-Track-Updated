  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-6 bg-gradient-hero">
      <div className="max-w-4xl w-full">
        ...
        <div className="flex flex-col space-y-4 md:grid md:grid-cols-3 md:gap-6 md:space-y-0 px-4 md:px-0">
          {roles.map((role) => (
            <div
              key={role.id}
              className="glass glass-hover rounded-2xl md:rounded-3xl p-4 md:p-8 border border-glass-border/50 text-center group cursor-pointer w-full"
            ...
            >
              ...
              <p className="text-muted-foreground mb-4 md:mb-8 leading-relaxed text-sm md:text-base hidden md:block">
                {role.description}
              </p>
              
              <Button 
                className="btn-gradient w-full py-3 md:py-3 rounded-xl md:rounded-xl text-base md:text-lg font-semibold group-hover:shadow-glow transition-all duration-300"
              >
